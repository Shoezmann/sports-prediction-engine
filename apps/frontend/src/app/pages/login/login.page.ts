    ...
    <div class="auth-container">
      ...
      <div class="auth-card">
        <div class="auth-header">
          ...
          <h2>Welcome back</h2>
          <p>Login to access your predictions and track performance.</p>
        </div>

        <!-- Social Login -->
        <div class="social-buttons">
          <button class="social-btn social-btn--google" (click)="socialLogin('google')" type="button">
          ...
          <button class="social-btn social-btn--github" (click)="socialLogin('github')" type="button">
          ...
          <button class="social-btn social-btn--apple" (click)="socialLogin('apple')" type="button">
            <svg class="social-btn__icon" viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
        ...
        <form [formGroup]="loginForm" (ngSubmit)="onSubmit()" class="auth-form">
          ...
          <button type="submit" class="btn-primary btn-submit" [disabled]="loginForm.invalid || isLoading">
            @if (isLoading) {
